      ...
      <View>
          ...
          <Card className="my-4 w-full h-44 overflow-hidden">
            <View className="flex-row items-center h-full px-2">
              <View className="flex-1 p-4 items-center justify-center">
                <Text
                  className={`${theme === "dark" ? "text-gray-400" : "text-gray-600"} text-lg`}
                >
                  Frekwencja
                </Text>
                ...
                <View className="mt-3 flex-row px-1">
                  <View
                    className={`flex-1 mx-1 rounded-lg items-center pt-3 h-16 ${theme === "dark" ? "bg-neutral-900 border border-neutral-800" : "bg-gray-100 border border-gray-200"}`}
                  >
                    <Text className="text-green-400 text-lg font-bold">
                      {stats.present}
                    </Text>
                    <Text
                      className={`${theme === "dark" ? "text-gray-500" : "text-gray-600 "} text-xs`}
                    >
                      Obecności
                    </Text>
                  </View>
        ...
        <View className="px-4 mt-4">
          ...
          <Card className="p-4 mb-4">
            <Text className={`${textClass} text-lg font-semibold mb-2`}>
              Filtruj po dacie
            </Text>
              ...
              <TouchableOpacity key={idx} onPress={() => handleRecordClick(it)}>
                <Card className="mt-3 p-4">
                  <View className="flex-row items-center justify-between">
                    <Text className={`${textClass} text-base font-medium`}>
                      {it.subject}
                    </Text>
                    <Text className={`${statusColor(it.status)} text-base`}>
                      {it.status}
                    </Text>
                  </View>
                  <Text
              ...
              <>
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    >
                      {new Date(selectedRecord.data).toLocaleDateString(
                        "pl-PL",
                ...
                >
                  ...
                  >
                    <Text
                      style={{ color: theme === "dark" ? "#E5E7EB" : "#111" }}
                    >
                      Zamknij
                    </Text>
                  </TouchableOpacity>
