	...
	return (
		<SafeAreaView edges={['bottom']} className={`flex-1 ${bg}`}>
			...
			<TouchableOpacity onPress={() => router.push('/(tabs)/settings')} className="mr-4">
				<Text className="text-blue-400 ml-4 text-2xl">◀  <Text className={`${textClass} text-2xl font-bold`}>Język</Text></Text>
			</TouchableOpacity>
			</View>

		<Text className={`${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'} mb-4 ml-4`}>Zarządzaj ustawieniami języka.</Text>
