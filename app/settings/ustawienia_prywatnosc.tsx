		...
		<SafeAreaView edges={['bottom']} className="flex-1 bg-black">
			<View className="flex-row mb-4 mt-4 ">
				<TouchableOpacity onPress={() => router.push('/(tabs)/settings')} className="mr-4">
					<Text className="text-blue-400 ml-4 text-2xl">◀  <Text className="text-white text-2xl font-bold">Prywatność</Text></Text>
				</TouchableOpacity>
			</View>

			<Text className="text-gray-300 mb-4 ml-4">Zarządzaj ustawieniami prywatności: zgody, blokady i inne.</Text>
